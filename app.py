...
# --- 1. 網頁基本設定 ---
st.set_page_config(page_title="FDA 510(k) Pro Searcher", page_icon="🩺", layout="wide")
        ...
        try:
            ...
            for i, item in enumerate(processed_results, 1):
                ...
                html_card = (
                    ...
                    f'<a href="https://www.accessdata.fda.gov/scripts/cdrh/cfdocs/cfPMN/pmn.cfm?ID={item["k_num"]}" target="_blank" style="color: #007bff; text-decoration: none; font-weight: 600; font-size: 0.9em;">🌐 官方數據庫詳細頁</a>'
                    f'{pdf_btn}'
                    f'</div>'
                    f'</div>'
                )
